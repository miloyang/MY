...
function SideBar() {
  return (
    <div>
      <div className="w-[110px] h-screen border-r-[1px] fixed flex flex-col justify-around items-center">
        <h2 className="-rotate-90 text-[20px] tracking-widest">HOMEPAGE</h2>
